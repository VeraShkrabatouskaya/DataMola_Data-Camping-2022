...
PARTITION BY HASH (CALENDAR_QUARTER_NUMBER)
...
SELECT DISTINCT CALENDAR_QUARTER_NUMBER FROM calendar;

SELECT partition_name, tablespace_name FROM ALL_TAB_PARTITIONS;

--Move partition

ALTER TABLE calendar MOVE PARTITION PART_1 TABLESPACE ts_dw_data_03; 

SELECT partition_name, tablespace_name FROM ALL_TAB_PARTITIONS;

--Truncate partition
ALTER TABLE calendar TRUNCATE PARTITION PART_1;

SELECT * FROM calendar PARTITION (PART_2);

--Add partition
ALTER TABLE calendar
    ADD PARTITION PART_3 TABLESPACE ts_dw_data_02;
ALTER TABLE calendar
    ADD PARTITION PART_4 TABLESPACE ts_dw_data_02;
...
ALTER TABLE calendar MOVE PARTITION PART_1 TABLESPACE ts_dw_data_02; 

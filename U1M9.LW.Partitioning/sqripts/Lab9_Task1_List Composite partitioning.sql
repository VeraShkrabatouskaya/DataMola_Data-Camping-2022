...
PARTITION BY LIST (CALENDAR_MONTH_NAME)
(
PARTITION PART_1 VALUES ('December', 'January', 'February'),
PARTITION PART_2 VALUES ('March', 'April', 'May'),
PARTITION PART_3 VALUES ('June', 'July', 'August'),
PARTITION PART_4 VALUES ('September', 'October', 'November')
)
...
MERGE PARTITIONS PART_2, PART_3 INTO PARTITION PART_5; 

ALTER TABLE calendar 
MERGE PARTITIONS PART_1, PART_4 INTO PARTITION PART_6; 
...
ALTER TABLE calendar MOVE PARTITION PART_5 TABLESPACE ts_dw_data_03 NOLOGGING COMPRESS; 
ALTER TABLE calendar MOVE PARTITION PART_6 TABLESPACE ts_dw_data_03 NOLOGGING COMPRESS; 

SELECT partition_name, tablespace_name FROM ALL_TAB_PARTITIONS;

--Split partition
ALTER TABLE calendar SPLIT PARTITION PART_5
VALUES ('March', 'April', 'May')
INTO
( PARTITION PART_7, PARTITION PART_8);
...
--Truncate partition
ALTER TABLE calendar TRUNCATE PARTITION PART_6;

SELECT * FROM calendar PARTITION (PART_6);
--Drop partition
ALTER TABLE calendar DROP PARTITION PART_6;

SELECT partition_name, tablespace_name FROM ALL_TAB_PARTITIONS;

--Add partition

ALTER TABLE calendar ADD PARTITION PART_1 VALUES ('December') TABLESPACE ts_dw_data_02;

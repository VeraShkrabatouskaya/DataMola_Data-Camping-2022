...
CREATE TABLE calendar (
    ...
    CONSTRAINT calendar_PK PRIMARY KEY (TIME_ID)
)
...
CREATE TABLE order_calendar
    ( order_id           NUMBER(10) NOT NULL,
      ...
      FOREIGN KEY(TIME_ID) REFERENCES calendar (TIME_ID)
    )
...
ALTER TABLE order_calendar MOVE PARTITION PART_2 TABLESPACE ts_dw_data_03 NOLOGGING COMPRESS; 

SELECT partition_name, tablespace_name FROM ALL_TAB_PARTITIONS;

--Truncate partition
ALTER TABLE order_calendar TRUNCATE PARTITION PART_2;

SELECT * FROM order_calendar PARTITION (PART_2);

--DROP
--drop table order_calendar;
--drop table calendar;
